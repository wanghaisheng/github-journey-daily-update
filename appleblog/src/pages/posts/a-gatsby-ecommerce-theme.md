...
cover:
  alt: cover
  square: https://fluxapi.borninsea.com/image/image_1734779858852_xgra3q
  url: https://fluxapi.borninsea.com/image/image_1734779858852_xgra3q
description: 'A Gatsby-based starter theme with e-commerce styled components'
featured: true
keywords: Gatsby,ecommerce,themes,Matter Design Team,CSS Modules,Prettier,React Helmet,Netlify,CleanShot,Gatsby E-commerce Theme
layout: ../../layouts/MarkdownPost.astro
meta:
- content: Alice Cooper
  name: author
- content: Gatsby,ecommerce,themes,Matter Design Team,CSS Modules,Prettier,React Helmet,Netlify,CleanShot,Gatsby E-commerce Theme
  name: keywords
pubDate: '2024-12-21 15:27:08'
tags:
- gatsby,ecommerce,theme,Matter Design Team,CSS Modules,Prettier,React Helmet,CleanShot,Netlify,CleanShot,README,deploy options,Heroku,GitHub仓库,Netlify CLI,Netlify
theme: light
