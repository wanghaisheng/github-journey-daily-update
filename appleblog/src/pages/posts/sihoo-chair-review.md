...
cover:
  alt: cover
  square: https://fluxapi.borninsea.com/image/image_1734782146083_l1iw4g
  url: https://fluxapi.borninsea.com/image/image_1734782146083_l1iw4g
description: 'No description provided.'
featured: true
keywords: versatile,landing,template,blog,docs,minimalism,functionality,astro,tailwindcss,prelineui,web,project,setup,portfolio,company,web,presence,installation,development,commands,deployment,building,sites,vercel,project,structure,static,assets,publishing,reources,customization,component,variables,props,component,instances,navigation,footer,links,social,media,starlight,documentation,lenis,smooth,scrolling,gsap,integration,scrollbar,seo,constants,metadata,layouts,structured,data,rich,snippets,astro,integrations,flexibility,alpha,beta,gamma,deployment,security,html,minification,contributing,license
layout: ../../layouts/MarkdownPost.astro
meta:
- content: Bob Johnson
  name: author
- content: versatile,landing,template,blog,docs,minimalism,functionality,astro,tailwindcss,prelineui,web,project,setup,portfolio,company,web,presence,installation,development,commands,deployment,building,sites,vercel,project,structure,static,assets,publishing,reources,customization,component,variables,props,component,instances,navigation,footer,links,social,media,starlight,documentation,lenis,smooth,scrolling,gsap,integration,scrollbar,seo,constants,metadata,layouts,structured,data,rich,snippets,astro,integrations,flexibility,alpha,beta,gamma,deployment,security,html,minification,contributing,license
  name: keywords
pubDate: '2024-12-21 15:27:08'
tags:
- Sohoo,chair,review,Versatile,Landing,Blog,Docs,Template,open-source,web,project,setup,minimalism,functionality,portfolio,company,blog, Astro,Tailwind CSS,Preline UI,view live demo,Getting Started,Installation,Development Commands,Deployment,Building Your Site,Deploying to Vercel,Project Structure,Static Assets and Public Resources,Customization,Editing Component Variables,Props in Component Instances,Customer Navigation and Footer Links,Naviagation Bar Links,Footer Links,Social Media Links,Integrations and Enhancements,Starlight Documentation,Lenis for Smooth Scrolling,GSAP Integration,Hiding Scrollbar,SEO Configuration,Robots.txt,Markdown/MDX,Image Integration,Astro Integrations,Flexibility with Integrations,Preline UI,Tailwind CSS,Deployment and Security,HTML Minification,Contributing,License
theme: light
title: sihoo-chair-review
---

# sihoo-chair-review

## Repository URL: 
[https://github.com/wanghaisheng/sihoo-chair-review](https://github.com/wanghaisheng/sihoo-chair-review)
