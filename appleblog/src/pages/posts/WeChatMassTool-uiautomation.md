...
featured: true
keywords: wechat_mass_tool, uiautomation, 微信自动发送, 群发消息, Windows系统, Python, PySide6, PyQt6, 开源, MIT License, 不封号, 安全, 微信群发助手, MVC架构, 用户友好界面, 智能群发, 丰富消息内容, 日志记录, 断点续传
layout: ../../layouts/MarkdownPost.astro
meta:
- content: Alice Cooper
  name: author
- content: wechat_mass_tool, uiautomation, 微信自动发送, 群发消息, Windows系统, Python, PySide6, PyQt6, 开源, MIT License, 不封号, 安全, 微信群发助手, MVC架构, 用户友好界面, 智能群发, 丰富消息内容, 日志记录, 断点续传
  name: keywords
pubDate: '2024-12-21 15:27:08'
tags:
- 我们chatmass工具,微信自动发送,微信群发消息,python工具,pyshide6,pyqt6,license-mit,开源项目,无需安装,快速启动,MacOS,Windows,群发助手,友好的用户界面,智能群发,消息内容,日志记录,断点续传,开源许可证,授权,GitHub,Release,注意事项,屏幕配置,项目简介,视频教程,快速启动,动图展示,支持项目,特性,贡献Notification
theme: light
