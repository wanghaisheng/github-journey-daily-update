...
cover:
  alt: cover
  square: https://fluxapi.borninsea.com/image/image_1734780065591_opkq0d
  url: https://fluxapi.borninsea.com/image/image_1734780065591_opkq0d
...
featured: true
keywords: 
AppointDent, Swedish dental appointment web app, microservices, publish-subscribe, client-server architectures, full-stack web application, distributed system, microservices, Sweden, resident, dentist, continuous integration, TypeScript, Node.js, Vite.js, Express.js, Solid.js, Sqlite3, Tailwind CSS, stress-testing, k6
...
tags:
- appointdent,swedish,dental appointment,web app,microservices,publish-subscribe,client-server,distributed system,typescript,node.js,vite.js,express.js,solid.js,sqlite3,tailwind css,full-stack,pre-requirements,stress-testing,k6
theme: light
title: AppointDent
---
