...
cover:
  alt: cover
  square: https://fluxapi.borninsea.com/image/image_1734780526287_fbd12r
  url: https://fluxapi.borninsea.com/image/image_1734780526287_fbd12r
description: '自建企业邮箱，构建你自己的域名邮箱，无需服务器 / Self built email / Build your own domain email without the need for a server'
featured: true
keywords: 自建企业邮箱,域名邮箱,Cloudflare,无需服务器,一键部署,手动部署,邮件详情,权限设计,用户状态,移动端支持
layout: ../../layouts/MarkdownPost.astro
meta:
- content: Jane Smith
  name: author
- content: 自建企业邮箱,域名邮箱,Cloudflare,无需服务器,一键部署,手动部署,邮件详情,权限设计,用户状态,移动端支持
  name: keywords
pubDate: '2024-12-21 15:27:08'
tags:
- self-built-email,cloudflare,email-system,cloud-serverless,Chinese,English,demo,deployment,todo-list
theme: light
