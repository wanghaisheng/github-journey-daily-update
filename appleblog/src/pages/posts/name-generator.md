...
featured: true
keywords: name-generator, 诗云, 姓名生成器, 汉字, 三字名, 音韵学规则, 过滤规则, 候选字规则, 登科录, 古人云, 历代人物传记资料库, 好名字, 多音字
layout: ../../layouts/MarkdownPost.astro
meta:
- content: Alice Cooper
  name: author
- content: name-generator, 诗云, 姓名生成器, 汉字, 三字名, 音韵学规则, 过滤规则, 候选字规则, 登科录, 古人云, 历代人物传记资料库, 好名字, 多音字
  name: keywords
pubDate: '2024-12-21 15:27:08'
tags:
- 诗云,名字生成器,中文名字生成,起名工具,音韵学规则,候选字规则,多音字取音标准,姓名库,历史进士,古人名字
theme: light
