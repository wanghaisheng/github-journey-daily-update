...
cover:
  alt: cover
  square: https://fluxapi.borninsea.com/image/image_1734782121620_krmqjh
  url: https://fluxapi.borninsea.com/image/image_1734782121620_krmqjh
...
featured: true
keywords: segment-anything, SegmentAnythingModel, SAM, SAM2, SegmentAnythingModel2, video segmentation, transformer architecture, MetaAIResearch, FAIR, dataset, SA-V dataset, promptable visual segmentation, user interaction, model-in-the-loop
layout: ../../layouts/MarkdownPost.astro
meta:
- content: Jane Smith
  name: author
- content: segment-anything, SegmentAnythingModel, SAM, SAM2, SegmentAnythingModel2, video segmentation, transformer architecture, MetaAIResearch, FAIR, dataset, SA-V dataset, promptable visual segmentation, user interaction, model-in-the-loop
  name: keywords
pubDate: '2024-12-21 15:27:08'
tags:
- segment-anything,sam,sam-2,object-masks,promptable-visual-segmentation,transformer-architecture,video-segmentation,meta-ai-research,fair,prompt-based-segmentation,dataset-collection,real-time-video-processing
theme: light
