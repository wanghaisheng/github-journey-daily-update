...
cover:
  alt: cover
  square: https://fluxapi.borninsea.com/image/image_1734781863436_5kdpe8j
  url: https://fluxapi.borninsea.com/image/image_1734781863436_5kdpe8j
description: 'No description provided.'
featured: true
keywords: open-source,template,minimalism,functionality, Astro, Tailwind CSS, Preline UI, web project setup, live demo, deployment, Vercel, Netlify, project structure, static assets, customization, component variables, navigation, footer, social media, integrations, enhancements, Starlight Documentation, Lenis, GSAP, scrollbar, SEO, metadata, structured data, rich snippets, robots.txt, Markdown/MDX, HTML minification, contributing, license
layout: ../../layouts/MarkdownPost.astro
meta:
- content: John Doe
  name: author
- content: open-source,template,minimalism,functionality, Astro, Tailwind CSS, Preline UI, web project setup, live demo, deployment, Vercel, Netlify, project structure, static assets, customization, component variables, navigation, footer, social media, integrations, enhancements, Starlight Documentation, Lenis, GSAP, scrollbar, SEO, metadata, structured data, rich snippets, robots.txt, Markdown/MDX, HTML minification, contributing, license
  name: keywords
pubDate: '2024-12-21 15:27:08'
tags:
- play-online-sprunki,versatile-landing,blog-template,docs-template,open-source-template,minimalism,functionality,astro,tailwind-css,preline-ui,web-presence,portfolio-showcasing,company-landing-page,blog-running,open-source,quick-setup,efficient-setup,functional-solution,aesthetically-pleasing,is
theme: light
title: play-online-sprunki
---

# play-online-sprunki

## Repository URL: 
[https://github.com/wanghaisheng/play-online-sprunki](https://github.com/wanghaisheng/play-online-sprunki)
