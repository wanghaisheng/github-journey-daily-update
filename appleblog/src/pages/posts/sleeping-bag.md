...
cover:
  alt: cover
  square: https://fluxapi.borninsea.com/image/image_1734782178963_cbn6o
  url: https://fluxapi.borninsea.com/image/image_1734782178963_cbn6o
description: 'No description provided.'
featured: true
keywords: open-source,template,versatile,web,project,simplified,mini,func,minimalism,functionality,content,frameworks,astro,tailwindcss,prelineui,portfolio,company,landing,blog,functional,aesthetically,pleasing,table,contents,installation,commands,deployment,building,vercel,netlify,project,structure,static,assets,pages,customization,component,variables,props,instances,navigation,footer,links,social,media,integration,enhancements,starlight,documentation,lenis,scrolling,gsap,scrollbar,seo,configuration,metadata,extending,structured,rich,snippets,using,constants,layouts,passing,individual,passing,metadata,ASTRO,SEO,modules,robots,markdown,mdx,image,tools,technologies,prelineui,flexibility,html,minification,contributing,license
layout: ../../layouts/MarkdownPost.astro
meta:
- content: Bob Johnson
  name: author
- content: open-source,template,versatile,web,project,simplified,mini,func,minimalism,functionality,content,frameworks,astro,tailwindcss,prelineui,portfolio,company,landing,blog,functional,aesthetically,pleasing,table,contents,installation,commands,deployment,building,vercel,netlify,project,structure,static,assets,pages,customization,component,variables,props,instances,navigation,footer,links,social,media,integration,enhancements,starlight,documentation,lenis,scrolling,gsap,scrollbar,seo,configuration,metadata,extending,structured,rich,snippets,using,constants,layouts,passing,individual,passing,metadata,ASTRO,SEO,modules,robots,markdown,mdx,image,tools,technologies,prelineui,flexibility,html,minification,contributing,license
  name: keywords
pubDate: '2024-12-21 15:27:08'
tags:
- minimalism,functionality,open-source-template,web-project-setup,astro,tailwind-css,preline-ui,web-presence,demo,installation,development-commands,deployment,site-building,vercel-netlify,project-structure,static-assets,public-resources,customization,component-variables,props-component-instances,nav-links,footer-links,social-media-links,integrations-enhancements,starlight-documentation,lenis-smooth-scrolling,gsap,hiding-scrollbar,seo-configuration,constants-applying-metadata,passing-individual-schema,extending-metadata-seo,structured-data-rich-snippets,astro-seo-integrations,robots-txt,markdown-mdx,image-integration,tools-technologies,preline-ui,tailwind-css,deployment-security,html-minification,contributing,license
theme: light
title: sleeping-bag
---
...
## Repository URL: 
[https://github.com/wanghaisheng/sleeping-bag](https://github.com/wanghaisheng/sleeping-bag)
