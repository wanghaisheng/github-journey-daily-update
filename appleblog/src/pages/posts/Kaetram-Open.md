...
cover:
  alt: cover
  square: https://fluxapi.borninsea.com/image/image_1734781118326_x296se
  url: https://fluxapi.borninsea.com/image/image_1734781118326_x296se
description: 'Kaetram is an open-source 2D HTML5 MMORPG. It is an extended version of BrowserQuest (BQ).'
featured: true
keywords: Kaetram,open-source,2D,HTML5,MMORPG,BrowserQuest,BQ,open issues,stars,forks,watch,GitHub,Discord,Youtube,Twitter,Reddit,MPL-2.0 License,early development,stages,assets,CC-BY-SA3.0,game-engine,bug reports,Tap Tap Adventure (TTA)
layout: ../../layouts/MarkdownPost.astro
meta:
- content: Jane Smith
  name: author
- content: Kaetram,open-source,2D,HTML5,MMORPG,BrowserQuest,BQ,open issues,stars,forks,watch,GitHub,Discord,Youtube,Twitter,Reddit,MPL-2.0 License,early development,stages,assets,CC-BY-SA3.0,game-engine,bug reports,Tap Tap Adventure (TTA)
  name: keywords
pubDate: '2024-12-21 15:27:08'
tags:
- open-source,2D,HTML5,MMORPG,BrowserQuest,game-engine,collaborative,gaming,early-development,CC-BY-SA3.0,Little+Workshop,Tap+Tap+Adventure,Demo,twitter,Youtube,Reddit,Discord
theme: light
title: Kaetram-Open
---
