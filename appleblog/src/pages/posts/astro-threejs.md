...
cover:
  alt: cover
  square: https://fluxapi.borninsea.com/image/image_1734780142467_rwkksf
  url: https://fluxapi.borninsea.com/image/image_1734780142467_rwkksf
description: 'Public Webpage (aitu.group)'
featured: true
keywords: astro,tailwind,threejs,three-noise,fontsource DM-Sans,AITU,webpage,project structure,public directory,source code,Markdown,contributing
layout: ../../layouts/MarkdownPost.astro
meta:
- content: Jane Smith
  name: author
- content: astro,tailwind,threejs,three-noise,fontsource DM-Sans,AITU,webpage,project structure,public directory,source code,Markdown,contributing
  name: keywords
pubDate: '2024-12-21 15:27:08'
tags:
- astro,threejs,tailwind,js,javascript,typescript,html,css,git,github,webpage,webdevelopment,githubcli,npm
theme: light
title: astro-threejs
---
