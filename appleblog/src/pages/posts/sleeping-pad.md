...
cover:
  alt: cover
  square: https://fluxapi.borninsea.com/image/image_1734782223061_pji30a
  url: https://fluxapi.borninsea.com/image/image_1734782223061_pji30a
description: 'No description provided.'
featured: true
keywords: open-source template,xx,minimalism,xx,functionality,xx,Astro,xx,Tailwind.CSS,xx,Preline.UI,xx,web project setup,xx,quick and efficient,xx,portfolio,xx,company landing page,xx,(blog,xx,versatile,xx,web presence,xx,view live demo,xx,getting started,xx,installation,xx,development commands,xx,deployment,xx,building your site,xx,vercel,xx,netlify,xx,project structure,xx,static assets,xx,pUBLIC resources,xx,customization,xx,component variables,xx,component instances,xx,navigation,xx,footer links,xx, social media links,xx,integrations,xx,starlight documentation,xx,lenis for smooth scrolling,xx,gsap integration,xx,hiding scrollbar,xx,seo configuration,xx,using constants.ts,xx,applying metadata,xx,passing individual schema,xx,extending metadata,xx,structured data,xx,astro seo integrations,xx,robots.txt,xx,markdown/mdx,xx,image integration,xx,astro integrations,xx,html minification,xx,tools and technologies,xx,preline ui,xx,tailwind css,xx,deployment and security
layout: ../../layouts/MarkdownPost.astro
meta:
- content: Alice Cooper
  name: author
- content: open-source template,xx,minimalism,xx,functionality,xx,Astro,xx,Tailwind.CSS,xx,Preline.UI,xx,web project setup,xx,quick and efficient,xx,portfolio,xx,company landing page,xx,(blog,xx,versatile,xx,web presence,xx,view live demo,xx,getting started,xx,installation,xx,development commands,xx,deployment,xx,building your site,xx,vercel,xx,netlify,xx,project structure,xx,static assets,xx,pUBLIC resources,xx,customization,xx,component variables,xx,component instances,xx,navigation,xx,footer links,xx, social media links,xx,integrations,xx,starlight documentation,xx,lenis for smooth scrolling,xx,gsap integration,xx,hiding scrollbar,xx,seo configuration,xx,using constants.ts,xx,applying metadata,xx,passing individual schema,xx,extending metadata,xx,structured data,xx,astro seo integrations,xx,robots.txt,xx,markdown/mdx,xx,image integration,xx,astro integrations,xx,html minification,xx,tools and technologies,xx,preline ui,xx,tailwind css,xx,deployment and security
  name: keywords
pubDate: '2024-12-21 15:27:08'
tags:
- open-source,template,minimalism,functionality,astero,tailwindcss,prelineui,webproject,setu,astro,webpresence,demo,installation,developmentcommands,deployment,vercel,netlify,projectstructure,staticassetsandpublicresources,customization,componentvariables,componentinstances,navigationfooterlinks,navigationbarlinks,footerlinks,socialmediabuttons,starlightdocumentation,lenis,smoothscrolling,gsapintegration,hideScrollbar,seoconfiguration,constants,metadata,passedindividualschema,extendingmetadata,structureddata,richsnippets,astroseo,integrations,flexibility,prelineui,tailwindcss,security,htmlminification,contributing,license
theme: light
title: sleeping-pad
---
...
## Repository URL: 
[https://github.com/wanghaisheng/sleeping-pad](https://github.com/wanghaisheng/sleeping-pad)
