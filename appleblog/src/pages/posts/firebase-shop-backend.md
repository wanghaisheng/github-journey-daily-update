...
cover:
  alt: cover
  square: https://fluxapi.borninsea.com/image/image_1734780673164_2ayi96
  url: https://fluxapi.borninsea.com/image/image_1734780673164_2ayi96
description: 'No description provided.'
featured: true
keywords: firebase,shop,backend,e-commerce,plus,application,starter,deploy,github-actions, Firesotre,database,CLI,Firebase-project-ID,Firebase-token,SERVER-OPERATOR-TOKEN,MARKET-TOKEN,e-commerce routes,private,auth-callback,authentication,database_tokens,web-hooks,e-com-plus
layout: ../../layouts/MarkdownPost.astro
meta:
- content: Jane Smith
  name: author
- content: firebase,shop,backend,e-commerce,plus,application,starter,deploy,github-actions, Firesotre,database,CLI,Firebase-project-ID,Firebase-token,SERVER-OPERATOR-TOKEN,MARKET-TOKEN,e-commerce routes,private,auth-callback,authentication,database_tokens,web-hooks,e-com-plus
  name: keywords
pubDate: '2024-12-21 15:27:08'
tags:
- firebase,cloud-functions,gitHub-actions,ecommerce,boilerplate,application-starter,e-com-plus,tokens,firestore,RDMS,repositories,secrets,database-management,authentication,api-endpoints,web-hooks,ci-cd
theme: light
