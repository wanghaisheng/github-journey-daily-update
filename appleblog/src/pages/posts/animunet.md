...
cover:
  alt: cover
  square: https://fluxapi.borninsea.com/image/image_1734779995007_axp5ma
  url: https://fluxapi.borninsea.com/image/image_1734779995007_axp5ma
description: 'a website where you can watch anime, made using next.js and animetize-api.'
featured: true
keywords: anime,Next.js,animetize-api,typescript,nextUI,vercel,performance,best anime website,English subs,English dubs,no sign-up required,screenshot,installation,details,clone repository,npm install,replacement values,development mode,production mode,local development,Vercel deployment,bug reporting
layout: ../../layouts/MarkdownPost.astro
meta:
- content: Alice Cooper
  name: author
- content: anime,Next.js,animetize-api,typescript,nextUI,vercel,performance,best anime website,English subs,English dubs,no sign-up required,screenshot,installation,details,clone repository,npm install,replacement values,development mode,production mode,local development,Vercel deployment,bug reporting
  name: keywords
pubDate: '2024-12-21 15:27:08'
tags:
- anime,website,next.js,animetize-api,typescript,vercel,NextUI
theme: light
title: animunet
---
