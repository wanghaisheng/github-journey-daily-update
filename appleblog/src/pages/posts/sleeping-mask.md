...
cover:
  alt: cover
  square: https://fluxapi.borninsea.com/image/image_1734782196408_lf3s
  url: https://fluxapi.borninsea.com/image/image_1734782196408_lf3s
description: 'No description provided.'
featured: true
keywords: open-source,template,versatility,minimalism,functionality,web,project,setup,Astro,Tailwind.CSS,Preline.UI,content,structure,deployment,customization,navigation,footer,links,social,media,integrations,enhancements,SEO,metadata,structured,data,Rich,Snippets,Google,Search,Tools,Technologies,Preline.UI,Tailwind.CSS,deployment,security,HTML,minification,contribution,license
layout: ../../layouts/MarkdownPost.astro
meta:
- content: Jane Smith
  name: author
- content: open-source,template,versatility,minimalism,functionality,web,project,setup,Astro,Tailwind.CSS,Preline.UI,content,structure,deployment,customization,navigation,footer,links,social,media,integrations,enhancements,SEO,metadata,structured,data,Rich,Snippets,Google,Search,Tools,Technologies,Preline.UI,Tailwind.CSS,deployment,security,HTML,minification,contribution,license
  name: keywords
pubDate: '2024-12-21 15:27:08'
tags:
- minimalism,functionality,open-source,web-project-setup,portfolio-showcase,company-landing-page,blog-running,astros-build,tailwind-css,preline-ui,view-live-demo,project-structure,static-assets-and-public-resources,customization,editing-component-variables,props-in-component-instances,customizing-navigation-and-footer-links,navigation-bar-links,footer-links,social-media-links,integrations-and-enhancements,starlight-documentation,lenis-smooth-scrolling,gsap-integration,hiding-scrollbar,seo-configuration,using-constantsts,applying-metadata-in-layouts,passing-individual-schema,extending-metadata-for-seo,structured-data-and-rich-snippets,using-astro-seo-integrations,robotstxt,markdown-mdx,image-integration,astro-integrations,flexibility-with-integrations,preline-ui,tailwind-css,deployment-and-security,html-minification,contributing,license
theme: light
title: sleeping-mask
---
...
## Repository URL: 
[https://github.com/wanghaisheng/sleeping-mask](https://github.com/wanghaisheng/sleeping-mask)
