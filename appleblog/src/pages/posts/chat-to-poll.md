...
cover:
  alt: cover
  square: https://fluxapi.borninsea.com/image/image_1734780330995_uaxisp
  url: https://fluxapi.borninsea.com/image/image_1734780330995_uaxisp
description: '「快速」打造「专属」问卷系统, 让调研「更轻松」'
featured: true
keywords: chat-to-poll,问卷系统,调研更轻松,JSON协议,启发式对话,XIAOJUSURVEY,轻量安全调研系统,一站式解决方案,40+种题型,100+精选模板,市场调研,客户满意度调研,在线考试,投票,报道,测评,多类型数据采集,智能逻辑编排,精细权限管理,数据在线分析,导出,主题定制,多端嵌入,安全可扩展,Vue3,ElementPlus,ReactNative,Web端,NestJS,MongoDB,智能化问卷,问卷标准化协议,问卷UI/UX规范
layout: ../../layouts/MarkdownPost.astro
meta:
- content: Alice Cooper
  name: author
- content: chat-to-poll,问卷系统,调研更轻松,JSON协议,启发式对话,XIAOJUSURVEY,轻量安全调研系统,一站式解决方案,40+种题型,100+精选模板,市场调研,客户满意度调研,在线考试,投票,报道,测评,多类型数据采集,智能逻辑编排,精细权限管理,数据在线分析,导出,主题定制,多端嵌入,安全可扩展,Vue3,ElementPlus,ReactNative,Web端,NestJS,MongoDB,智能化问卷,问卷标准化协议,问卷UI/UX规范
  name: keywords
pubDate: '2024-12-21 15:27:08'
tags:
- chat-to-poll, questionnaire-system, easy-to-use, customizable, secure, extensible, multi-purpose, enterprise-grade, personal-solution, data-analysis, online-survey, theme-customization, multi-end-embedded, smart-survey, function-rich, user-friendly, permission-management, data-export, intelligence-questionnaire, web-end-technology, server-end-technology, comprehensive-professional, standards, ui-ux-standard
theme: light
title: chat-to-poll
---
