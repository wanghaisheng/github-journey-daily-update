...
cover:
  alt: cover
  square: https://fluxapi.borninsea.com/image/image_1734780746294_tz4ce
  url: https://fluxapi.borninsea.com/image/image_1734780746294_tz4ce
description: 'Some data storage costing nothing'
featured: true
keywords: free-databases,serverless-databases,Aiven,CockroachDB,Convex,Deta,FaunaDB,Firebase,Fly.io,Koyeb,MongoDB Atlas,Neon,PocketHost,Supabase,TiDB Cloud,Turso,Upstash,Vercel Postgres,Xata,Yugabyte,cookies-data-store,PRs-welcome,MIT-license
layout: ../../layouts/MarkdownPost.astro
meta:
- content: Jane Smith
  name: author
- content: free-databases,serverless-databases,Aiven,CockroachDB,Convex,Deta,FaunaDB,Firebase,Fly.io,Koyeb,MongoDB Atlas,Neon,PocketHost,Supabase,TiDB Cloud,Turso,Upstash,Vercel Postgres,Xata,Yugabyte,cookies-data-store,PRs-welcome,MIT-license
  name: keywords
pubDate: '2024-12-21 15:27:08'
tags:
- free-databases,serverless-databases,testing,database-providers,todo-list,vercel,issue-pr-welcome,MIT-license,aiven,cockroachdb,convex,deta,fauna-db,firebase,fly-io,koyeb,mongodb-atlas,neon,pockethost,supabase,tembo,tidb-cloud,turso,upstash,xata,yugabyte,local-testing,unit-tests,cypress-tests
theme: light
