...
cover:
  alt: cover
  square: https://fluxapi.borninsea.com/image/image_1734780840056_hh539t
  url: https://fluxapi.borninsea.com/image/image_1734780840056_hh539t
description: 'e-commerce website template in React (gatsby)'
featured: true
keywords: e-commerce, React, Gatsby, Redux, MUI, template, static site generation, SEO, cart logic, checkout logic, search filter, authentication, modular logic, customization, Node.js, npm, yarn, development server, production build, clean project
layout: ../../layouts/MarkdownPost.astro
meta:
- content: Jane Smith
  name: author
- content: e-commerce, React, Gatsby, Redux, MUI, template, static site generation, SEO, cart logic, checkout logic, search filter, authentication, modular logic, customization, Node.js, npm, yarn, development server, production build, clean project
  name: keywords
pubDate: '2024-12-21 15:27:08'
tags:
- e-commerce,template,React,Gatsby,Redux,MUI,responsive,stylish,productivity,web-developer,e-commerce-template,static-site,SEO,authentication,search-filter, cart,modular-logic
theme: light
