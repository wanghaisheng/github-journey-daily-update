...
cover:
  alt: cover
  square: https://fluxapi.borninsea.com/image/image_1734782068989_0o50zr
  url: https://fluxapi.borninsea.com/image/image_1734782068989_0o50zr
...
featured: true
keywords:  SAM2, Meta, Segment Anything Model 2, model checkpoints, example notebooks, AI at Meta, FAIR, Nikhila Ravi, Valentin Gabeur, Yuan-Ting Hu, Ronghang Hu, Chaitanya Ryali, Tengyu Ma, Haitham Khedr, Roman Rädle, Chloe Rolland, Laura Gustafson, Eric Mintun, Junting Pan, Kalyan Vasudev Alwala, Nicolas Carion, Chao-Yuan Wu, Ross Girshick, Piotr Dollár, Christoph Feichtenhofer, Paper, Project, Demo, Dataset, Blog, BibTeX, SAM architecture, transformer architecture, streaming memory, model-in-the-loop data engine, SA-V dataset, video segmentation, multi-object tracking, VOS, torch.compile
layout: ../../layouts/MarkdownPost.astro
meta:
- content: Bob Johnson
  name: author
- content:  SAM2, Meta, Segment Anything Model 2, model checkpoints, example notebooks, AI at Meta, FAIR, Nikhila Ravi, Valentin Gabeur, Yuan-Ting Hu, Ronghang Hu, Chaitanya Ryali, Tengyu Ma, Haitham Khedr, Roman Rädle, Chloe Rolland, Laura Gustafson, Eric Mintun, Junting Pan, Kalyan Vasudev Alwala, Nicolas Carion, Chao-Yuan Wu, Ross Girshick, Piotr Dollár, Christoph Feichtenhofer, Paper, Project, Demo, Dataset, Blog, BibTeX, SAM architecture, transformer architecture, streaming memory, model-in-the-loop data engine, SA-V dataset, video segmentation, multi-object tracking, VOS, torch.compile
  name: keywords
pubDate: '2024-12-21 15:27:08'
tags:
- code,repository,model,inference,video,segmentation,transformer,dataset,promptable,AI,Meta,FAIR,paper,project,demo,BibTeX,citation,M2SAM,SA-V
theme: light
title: sam2
---
...
## Repository URL: 
[https://github.com/wanghaisheng/sam2](https://github.com/wanghaisheng/sam2)
