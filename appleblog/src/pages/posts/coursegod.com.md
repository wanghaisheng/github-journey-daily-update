...
cover:
  alt: cover
  square: https://fluxapi.borninsea.com/image/image_1734780443849_zbml4
  url: https://fluxapi.borninsea.com/image/image_1734780443849_zbml4
...
featured: true
keywords: QwikJS,QwikCity,Vite,Qwik,QwikDev,Stripe,Tailwind,AuthJS,DrizzleORM,StaticSiteGenerator(SSG),Cloudflare,Netlify,ExpressServer,ViteDevelopmentServer,TypeScript,VercelEdgeFunctions
layout: ../../layouts/MarkdownPost.astro
meta:
- content: Bob Johnson
  name: author
- content: QwikJS,QwikCity,Vite,Qwik,QwikDev,Stripe,Tailwind,AuthJS,DrizzleORM,StaticSiteGenerator(SSG),Cloudflare,Netlify,ExpressServer,ViteDevelopmentServer,TypeScript,VercelEdgeFunctions
  name: keywords
pubDate: '2024-12-21 15:27:08'
tags:
- qwikjs,qwikcity,qwik,qwikdocs,qwikgithub,qwikdiscord,qwikdev,stripe,tailwind,authjs,drizzleorm,vite,vercel,netlify,cloudflare,static-site-generation,typescript,ssr,public-directory,directory-based-routing,layout-files,Vite-develop-server,production-build,Vercel-edge_functions,pnpm,qwik-city-app
theme: light
title: coursegod.com
---
