...
cover:
  alt: cover
  square: https://fluxapi.borninsea.com/image/image_1734781698842_50vsm8
  url: https://fluxapi.borninsea.com/image/image_1734781698842_50vsm8
description: 'OpenUI let's you describe UI using your imagination, then see it rendered live.'
featured: true
keywords: openui,openui,imagination,render,live,Ulbuilding,UI,components,fun,fast,flexible,W&B,OpenAI,Groq,LiteLLM,v0,demo,OpenAI_API_KEY,GROQ_API_KEY,GEMINI_API_KEY,ANTHROPIC_API_KEY,C cohere_API_KEY,MISTRAL_API_KEY,OPENAI_COMPATIBLE_ENDPOINT,OPENAI_COMPATIBLE_API_KEY,ollama,LLaVA,uv,Docker,localhost,git,uv
layout: ../../layouts/MarkdownPost.astro
meta:
- content: John Doe
  name: author
- content: openui,openui,imagination,render,live,Ulbuilding,UI,components,fun,fast,flexible,W&B,OpenAI,Groq,LiteLLM,v0,demo,OpenAI_API_KEY,GROQ_API_KEY,GEMINI_API_KEY,ANTHROPIC_API_KEY,C cohere_API_KEY,MISTRAL_API_KEY,OPENAI_COMPATIBLE_ENDPOINT,OPENAI_COMPATIBLE_API_KEY,ollama,LLaVA,uv,Docker,localhost,git,uv
  name: keywords
pubDate: '2024-12-21 15:27:08'
tags:
- openui,openui_rendering,ui_description,imagination_based_ui,web_components,react,svelte,live_rendering,v0_dev,open_source,flexible_ui_building,openai_api,groq_api,lite_llm,gemini_api,anthropic_api,cohere_api,mistral_api,openai_compatible_api,ollama_model,localai,ui_model_selector,docker_environment_variables,python_backend
theme: light
title: openui
---
