...
featured: true
keywords: ichingshifa, Iching, Yarrow Stalks, GanBox, Zhouyi, 六十四卦, 六爻, 京房易, 爻辭, 日期占卦, 占卜, 叟策, 大衍之數, 筮法, 邏輯, 邏爻, 传统占卜, Python package, PyPI, Telegram, PayPal, 蓍草, 卦术, 適一法, 分二, 挂一, 揲四, 归奇, 邏gua, 大衍筮法, 蓍草占卜
layout: ../../layouts/MarkdownPost.astro
meta:
- content: Alice Cooper
  name: author
- content: ichingshifa, Iching, Yarrow Stalks, GanBox, Zhouyi, 六十四卦, 六爻, 京房易, 爻辭, 日期占卦, 占卜, 叟策, 大衍之數, 筮法, 邏輯, 邏爻, 传统占卜, Python package, PyPI, Telegram, PayPal, 蓍草, 卦术, 適一法, 分二, 挂一, 揲四, 归奇, 邏gua, 大衍筮法, 蓍草占卜
  name: keywords
pubDate: '2024-12-21 15:27:08'
tags:
- ichingshifa,i-ching,yarrow_stalks_divination,zhōu yì,yì jīng,六十四卦,yiliu yao,bagua,shizì,bowanyin,shaoyang,shaoyin,laoyin,laoyang,大衍之數,太一,分二,掛一,揲四,歸奇,占卜,预测,python包,tensorflow chat,telegram chat,paypalDonate
theme: light
title: ichingshifa
---
