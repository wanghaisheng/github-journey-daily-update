...
cover:
  alt: cover
  square: https://fluxapi.borninsea.com/image/image_1734780783321_m94pot
  url: https://fluxapi.borninsea.com/image/image_1734780783321_m94pot
description: 'No description provided.'
featured: true
keywords: game-app-starter,web-app-starter-project,ci-desktop,ci-android,typescript,postcss,wasp,electron-builder,capacitor,workbox,service-worker,xhr,webapp,progressive-web-app,modern-normalize,postcss-preset-env,esbuild,promise-based-web-workers,worker-async,prettier,eslint,polyfills,hot-reloading-cs,github-actions,xhr-polyfills,multi-threading,mixins,wasm
layout: ../../layouts/MarkdownPost.astro
meta:
- content: Alice Cooper
  name: author
- content: game-app-starter,web-app-starter-project,ci-desktop,ci-android,typescript,postcss,wasp,electron-builder,capacitor,workbox,service-worker,xhr,webapp,progressive-web-app,modern-normalize,postcss-preset-env,esbuild,promise-based-web-workers,worker-async,prettier,eslint,polyfills,hot-reloading-cs,github-actions,xhr-polyfills,multi-threading,mixins,wasm
  name: keywords
pubDate: '2024-12-21 15:27:08'
tags:
- game-app-starter,web-app-starter-project,cross-platform-development,github-actions,windows-development,linux-development,android-development,type-script,postcss,esbuild,pwa,workbox,electron-builder,webpack,wasm
theme: light
